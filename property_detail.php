    ...
    <div class="property-summary page-container">
        ...
        <div class="row no-gutters">
            ...
            ?><div class="button-container col-6">
                    <a class="nav-link btn btn-primary" href="#" data-toggle="modal" data-target="#login-modal">Book Now</a>
                </div> <?php
                        ...
                        ?>
                <div class="button-container col-6">
                    <a class="nav-link btn btn-primary btn btn-primary" data-toggle="modal" data-target="#book-modal" href="#" name="book">Book Now</a>
                </div>
            <?php
                        include "booked.php";
                    }
